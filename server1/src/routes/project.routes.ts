...
// 8. Make project live (Vercel deployment)
router.post('/:id/make-live', ProjectController.makeLive);
router.post('/:id/rebuild', ProjectController.rebuild);
router.post('/:id/portfolio-data', ProjectController.updatePortfolioData);

// 9. Delete project and system status
