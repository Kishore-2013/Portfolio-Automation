...
export const TemplateCard = memo(({
    ...
    const gallery = React.useMemo(() => {
        ...
        return items.length > 0 ? items : ["https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=1280&auto=format&fit=crop"]
    ...
    const handleUseTemplate = () => {
        const templateData = { id, name, description, previewImage, previews, files, gitRepoUrl };
        if (onSelect) {
                ...
                <div className="relative h-60 w-full overflow-hidden p-2.5 pb-0">
                    <div className="relative h-full w-full overflow-hidden rounded-[1.5rem] bg-muted shadow-inner">
                        <AnimatePresence mode="popLayout">
                            ...
                            >
                                <Image
                                    src={gallery[imageIndex] || "https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=1280&auto=format&fit=crop"}
                                    alt={name}
                                    fill
                        ...
                        >
                            ...
                            <div className="w-full lg:w-[420px] p-8 md:p-10 flex flex-col justify-between border-l border-border bg-card">
                                ...
                                <div className="space-y-3 pt-8">
                                    ...
                                    >
                                        {onSelect ? "Confirm Selection" : "Use This Blueprint"} <ArrowRight className="w-4 h-4" />
                                    </button>
                                    {gitRepoUrl && (
                                        <a 
                                            href={gitRepoUrl} 
